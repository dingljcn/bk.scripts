                ...
                <div id="dinglj-page-view">${
                    getPageNames().map(key => `<div class="dinglj-page">
                        <div id="dinglj-page-wait-box">
                            <img style="width: 300px" src="https://dingljcn.github.io/bk.scripts/src/loading.gif"/>
...
async function onClickSomeDay_002(htmlElement, day4Event, date) {
    getById('today-commit-container').innerHTML = `<div style="text-align: center; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
        <img src="https://dingljcn.github.io/bk.scripts/src/loading.gif" style="max-width: 200px;">
